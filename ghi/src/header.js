  ...
  return (
    <div className="header-container">
      ...
      <div className="nav-buttons">
        <Link to="/mainpage/" className="btn btn-info text-white m-2">
          Sweet Home
        </Link>
        ...
        {token.length > 0 ? (
          <>
            ...
            <Link to="/users" className="btn btn-info text-white m-2">
              Connect!
            </Link>
          </>
        ) : (
          <>
            ...
            <Link to="/login/" className="btn btn-info text-white m-2">
              Log In
            </Link>
          </>
        )}
        ...
        {isLoggedIn && userType === "business" && (
          <>
            ...
            <Link to="/transactions/" className="btn btn-info text-white">
              Transactions
            </Link>
        ...
        <Link to="/create-candy" className="btn btn-info text-white m-2">
          Create Candy(This will not be here later)
        </Link>
        <Link
          to={`/users/user/${id}`}
        ...
        <Link to="/orders" className="btn btn-info text-white m-2">
          Pending Orders
        </Link>
